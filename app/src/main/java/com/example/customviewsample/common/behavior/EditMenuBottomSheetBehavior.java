...
package com.example.customviewsample.common.behavior;
...
import com.example.customviewsample.utils.ColorUtilsKt;
import com.example.customviewsample.utils.DensityUtilKt;
...
public class EditMenuBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {

    public abstract static class EditMenuBottomSheetCallback {
    ...
    @Nullable
    EditMenuViewDragHelper viewDragHelper;
    ...
    @NonNull
    private final ArrayList<EditMenuBottomSheetCallback> callbacks = new ArrayList<>();
    ...
    public EditMenuBottomSheetBehavior() {
    }

    public EditMenuBottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        peekHeightGestureInsetBuffer = DensityUtilKt.dp2px(48);

        TypedArray a = context.obtainStyledAttributes(attrs, com.google.android.material.R.styleable.BottomSheetBehavior_Layout);
        if (a.hasValue(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_backgroundTint)) {
            this.backgroundTint = ColorUtilsKt.getColorStateList(
                    context, a, com.google.android.material.R.styleable.BottomSheetBehavior_Layout_backgroundTint);
        }
        if (a.hasValue(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_shapeAppearance)) {
            this.shapeAppearanceModelDefault = ShapeAppearanceModel.builder(context, attrs, com.google.android.material.R.attr.bottomSheetStyle, DEF_STYLE_RES).build();
        }
        ...
        if (a.hasValue(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_android_maxWidth)) {
            setMaxWidth(
                    a.getDimensionPixelSize(
                            com.google.android.material.R.styleable.BottomSheetBehavior_Layout_android_maxWidth, NO_MAX_SIZE));
        }

        if (a.hasValue(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_android_maxHeight)) {
            setMaxHeight(
                    a.getDimensionPixelSize(
                            com.google.android.material.R.styleable.BottomSheetBehavior_Layout_android_maxHeight, NO_MAX_SIZE));
        }
        ...
        /*setDraggableOnNestedScroll(
                a.getBoolean(
                        com.google.android.material.R.styleable.BottomSheetBehavior_Layout_behavior_draggableOnNestedScroll, true));*/
        ...
        setSignificantVelocityThreshold(
                a.getInt(
                        com.google.android.material.R.styleable.BottomSheetBehavior_Layout_behavior_significantVelocityThreshold,
        ...
        marginLeftSystemWindowInsets =
                a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_marginLeftSystemWindowInsets, false);
        marginRightSystemWindowInsets =
                a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_marginRightSystemWindowInsets, false);
        marginTopSystemWindowInsets =
                a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_marginTopSystemWindowInsets, false);
        shouldRemoveExpandedCorners =
                a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_shouldRemoveExpandedCorners, true);
    ...
    public boolean onLayoutChild(
        ...
        if (viewRef == null) {
            ...
            peekHeightMin = DensityUtilKt.dp2px(64);
        ...
        if (viewDragHelper == null) {
            viewDragHelper = EditMenuViewDragHelper.create(parent, dragCallback);
        }
     ...
     * @deprecated use {@link #addBottomSheetCallback(EditMenuBottomSheetCallback)} and {@link
     * #removeBottomSheetCallback(EditMenuBottomSheetCallback)} instead
     */
    @Deprecated
    public void setBottomSheetCallback(EditMenuBottomSheetCallback callback) {
        Log.w(
                TAG,
     ...
     * @param callback The callback to notify when bottom sheet events occur.
     */
    public void addBottomSheetCallback(@NonNull EditMenuBottomSheetCallback callback) {
     ...
     */
    public void removeBottomSheetCallback(@NonNull EditMenuBottomSheetCallback callback) {
    ...
    private final EditMenuViewDragHelper.Callback dragCallback =
            new EditMenuViewDragHelper.Callback() {
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull EditMenuBottomSheetBehavior<?> behavior) {
            super(superState);
    ...
    public static <V extends View> EditMenuBottomSheetBehavior<V> from(@NonNull V view) {
        ...
        if (!(behavior instanceof EditMenuBottomSheetBehavior)) {
            throw new IllegalArgumentException("The view is not associated with BottomSheetBehavior");
        }
        return (EditMenuBottomSheetBehavior<V>) behavior;
    }
        ...
        if (!fitToContents && state != STATE_HALF_EXPANDED) {
            expandHalfwayActionIds.put(
                    ...
                    addAccessibilityActionForState(
                            view, com.google.android.material.R.string.bottomsheet_action_expand_halfway, STATE_HALF_EXPANDED));
        }
