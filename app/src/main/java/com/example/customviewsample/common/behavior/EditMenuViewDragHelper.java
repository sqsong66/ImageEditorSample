...
public class EditMenuViewDragHelper {
    ...
    private final EditMenuViewDragHelper.Callback mCallback;
     ...
     */
    public static EditMenuViewDragHelper create(@NonNull ViewGroup forParent, @NonNull EditMenuViewDragHelper.Callback cb) {
        return new EditMenuViewDragHelper(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static EditMenuViewDragHelper create(@NonNull ViewGroup forParent, float sensitivity,
                                                @NonNull EditMenuViewDragHelper.Callback cb) {
        final EditMenuViewDragHelper helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private EditMenuViewDragHelper(@NonNull Context context, @NonNull ViewGroup forParent,
                                   @NonNull EditMenuViewDragHelper.Callback cb) {
        if (forParent == null) {
